...
new_local_repository(
    ...
    path = "/home/wwei6/fbsource/fbcode/third-party2/cuda/11.4.2/platform010/76ebdda/",
    #path = "/usr/",
)
...
new_local_repository(
    name = "libtorch",
    path = "/data/users/wwei6/miniconda3/envs/mypy38-trt/lib/python3.8/site-packages/torch",
    build_file = "third_party/libtorch/BUILD"
)
...
new_local_repository(
    name = "cudnn",
    #path = "/data/users/wwei6/Work/bazel-install/cudnn/",
    path = "/home/wwei6/fbsource/fbcode/third-party2/cudnn/8.0.5/platform010/0259c85/",
    build_file = "@//third_party/cudnn/local:BUILD"
)

new_local_repository(
   name = "tensorrt",
   path = "/data/users/wwei6/save/TensorRT-8.2.1.8/",
